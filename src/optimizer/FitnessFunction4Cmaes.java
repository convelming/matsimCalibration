 ...
 */
public class FitnessFunction4Cmaes implements MultivariateFunction {
    private static final Logger log = LogManager.getLogger(FitnessFunction4Cmaes.class);

    Scenario scenario;
    Map<Person, List<Plan>> planList;

    public FitnessFunction4Cmaes(Scenario scenario, Map<Person, List<Plan>> planList) {
